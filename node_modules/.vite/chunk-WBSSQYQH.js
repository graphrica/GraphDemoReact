...
var logger, Coder, Writer, Reader;
...
function pack(writer, coders, values) {
  ...
  if (Array.isArray(values)) {
    ...
    arrayValues = coders.map((coder) => {
      ...
      if (!name) {
        logger2.throwError("cannot encode object for signature with missing names", Logger.errors.INVALID_ARGUMENT, {
          argument: "values",
          coder,
          value: values
        });
      ...
      if (unique[name]) {
        logger2.throwError("cannot encode object for signature with duplicate names", Logger.errors.INVALID_ARGUMENT, {
          argument: "values",
          coder,
          value: values
        });
      ...
      decode(reader) {
        ...
        if (count === -1) {
          ...
          if (count * 32 > reader._data.length) {
            logger2.throwError("insufficient data length", Logger.errors.BUFFER_OVERRUN, {
...
function parseParamType(param, allowIndexed) {
  ...
  function throwError(i) {
    logger3.throwArgumentError(`unexpected character at position ${i}`, "param", param);
  }
...
var logger3, _constructorGuard, ModifiersBytes, ModifiersNest, FormatTypes, paramTypeArray, ParamType, Fragment, EventFragment, ConstructorFragment, FunctionFragment, ErrorFragment, regexIdentifier, regexParen;
var init_fragments = __esm({
  "node_modules/@ethersproject/abi/lib.esm/fragments.js"() {
    ...
    ParamType = class {
      constructor(constructorGuard, params) {
        if (constructorGuard !== _constructorGuard) {
          logger3.throwError("use fromString", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    Fragment = class {
      constructor(constructorGuard, params) {
        if (constructorGuard !== _constructorGuard) {
          logger3.throwError("use a static from method", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    ConstructorFragment = class extends Fragment {
      format(format) {
        ...
        if (format === FormatTypes.sighash) {
          logger3.throwError("cannot format a constructor for sighash", Logger.errors.UNSUPPORTED_OPERATION, {
...
//# sourceMappingURL=chunk-WBSSQYQH.js.map

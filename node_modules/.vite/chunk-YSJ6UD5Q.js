...
var init_version = __esm({
  "node_modules/@ethersproject/wordlists/lib.esm/_version.js"() {
    init_define_process_env();
    version = "wordlists/5.6.0";
  }
});

// node_modules/@ethersproject/wordlists/lib.esm/wordlist.js
var exportWordlist, logger, Wordlist;
...
var logger2, N, MasterSecret, HardenedBit, _constructorGuard, defaultPath, HDNode;
  ...
  "node_modules/@ethersproject/hdnode/lib.esm/index.js"() {
    ...
    HDNode = class {
      constructor(constructorGuard, privateKey, publicKey, parentFingerprint, chainCode, index, depth, mnemonicOrPath) {
        logger2.checkNew(new.target, HDNode);
...
function _decrypt(data, key, ciphertext) {
  ...
  if (cipher === "aes-128-ctr") {
    ...
    const aesCtr = new import_aes_js.default.ModeOfOperation.ctr(key, counter);
...
function _getAccount(data, key) {
  ...
  if (!privateKey) {
    logger3.throwError("unsupported cipher", Logger.errors.UNSUPPORTED_OPERATION, {
      operation: "decrypt"
    });
  }
...
function encrypt(account, password, options, progressCallback) {
  ...
  return import_scrypt_js.default.scrypt(passwordBytes, salt, N2, r, p, 64, progressCallback).then((key) => {
    ...
    const mnemonicKey = key.slice(32, 64);
    const counter = new import_aes_js.default.Counter(iv);
    const aesCtr = new import_aes_js.default.ModeOfOperation.ctr(derivedKey, counter);
...
var import_aes_js, import_scrypt_js, __awaiter, logger3, KeystoreAccount;
...
function decrypt2(json, password) {
  ...
  if (!encseed || encseed.length % 16 !== 0) {
    logger4.throwArgumentError("invalid encseed", "json", json);
  }
  const key = arrayify(pbkdf2(password, password, 2e3, 32, "sha256")).slice(0, 16);
  const iv = encseed.slice(0, 16);
  const encryptedSeed = encseed.slice(16);
  const aesCbc = new import_aes_js2.default.ModeOfOperation.cbc(key, iv);
  const seed = import_aes_js2.default.padding.pkcs7.strip(arrayify(aesCbc.decrypt(encryptedSeed)));
  let seedHex = "";
...
var import_aes_js2, logger4, CrowdsaleAccount;
...
export {
  ...
  isValidMnemonic,
  getAccountPath,
  init_lib16 as init_lib2,
  require_aes_js,
  getJsonWalletAddress,
  encrypt,
  decryptJsonWallet,
  decryptJsonWalletSync,
  init_lib17 as init_lib3
};
//# sourceMappingURL=chunk-YSJ6UD5Q.js.map

...
// dep:@web3-onboard_injected-wallets
init_define_process_env();
...
(function(ProviderIdentityFlag2) {
  ...
  ProviderIdentityFlag2["BlankWallet"] = "isBlank";
...
(function(ProviderLabel2) {
  ...
  ProviderLabel2["BlankWallet"] = "BlankWallet";
...
var metamask = {
  ...
  getIcon: async () => (await import("./metamask-W43ANGA3.js")).default,
  getInterface: async () => ({
...
var brave = {
  ...
  getIcon: async () => (await import("./brave-WMEMNV4Y.js")).default,
  getInterface: async () => {
...
var binance = {
  ...
  getIcon: async () => (await import("./binance-DS3MJ2DL.js")).default,
  getInterface: async () => {
    if (window.BinanceChain) {
      window.BinanceChain.isUnlocked = false;
    }
    const provider = createEIP1193Provider(window.BinanceChain, __spreadProps(__spreadValues({}, !window.BinanceChain.isUnlocked && {
...
var coinbase = {
  ...
  injectedNamespace: InjectedNameSpace.Ethereum,
  checkProviderIdentity: ({ provider }) => !!provider && !!provider[ProviderIdentityFlag.Coinbase] || !!provider && !!provider.providers && !!provider.providers[0] && !!provider.providers[0][ProviderIdentityFlag.CoinbaseExtension],
  getIcon: async () => (await import("./coinbase-BKRBVSCP.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
...
var detected = {
  ...
  getIcon: async () => (await import("./detected-ZUSLF7PD.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["all"]
...
var trust = {
  ...
  getIcon: async () => (await import("./trust-UVF4JU4Z.js")).default,
  getInterface: async () => ({
...
var opera = {
  ...
  getIcon: async () => (await import("./opera-SNXAMV22.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
...
var status = {
  ...
  getIcon: async () => (await import("./status-FGQIBMAZ.js")).default,
  getInterface: async () => {
    const provider = window.ethereum;
    return {
      provider
...
var alphawallet = {
  ...
  getIcon: async () => (await import("./alphawallet-LFWKUY2W.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var atoken = {
  ...
  getIcon: async () => (await import("./atoken-XUEKWHMZ.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var bitpie = {
  ...
  getIcon: async () => (await import("./bitpie-WPLEALGA.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var blankwallet = {
  ...
  getIcon: async () => (await import("./blankwallet-J4VSP5EJ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var dcent = {
  ...
  getIcon: async () => (await import("./dcent-DDNBVLDD.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var frame = {
  ...
  getIcon: async () => (await import("./frame-7GQGDZ77.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["desktop"]
...
var huobiwallet = {
  ...
  getIcon: async () => (await import("./huobiwallet-E42IAAYT.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var hyperpay = {
  ...
  getIcon: async () => (await import("./hyperpay-TKW3FB7H.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var imtoken = {
  ...
  getIcon: async () => (await import("./imtoken-ED736MLE.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var liquality = {
  ...
  getIcon: async () => (await import("./liquality-TZU3AMPY.js")).default,
  getInterface: async () => {
...
var meetone = {
  ...
  getIcon: async () => (await import("./meetone-NLR24UBD.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var mykey = {
  ...
  getIcon: async () => (await import("./mykey-UG5MR6IX.js")).default,
  getInterface: async () => ({
    provider: window.ethereum
  }),
  platforms: ["mobile"]
...
var ownbit = {
  ...
  getIcon: async () => (await import("./ownbit-RBMG2KMB.js")).default,
  getInterface: async () => {
...
var tokenpocket = {
  ...
  getIcon: async () => (await import("./tokenpocket-ETHYVCDK.js")).default,
...
var tp = {
  ...
  getIcon: async () => (await import("./tp-HRAQEZNK.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum, {
      wallet_switchEthereumChain: UNSUPPORTED_METHOD,
      eth_selectAccounts: UNSUPPORTED_METHOD
...
var xdefi = {
  ...
  getIcon: async () => (await import("./xdefi-X4YATAWD.js")).default,
  getInterface: async () => ({
...
var oneInch = {
  ...
  getIcon: async () => (await import("./oneInch-S5NQK27M.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
var tokenary = {
  ...
  getIcon: async () => (await import("./tokenary-2P4XB4KQ.js")).default,
  getInterface: async () => ({
    provider: createEIP1193Provider(window.ethereum)
  }),
  platforms: ["mobile"]
...
init_define_process_env();
var remove = ({ detected: detected2, metamask: metamask2 }) => ({ label }) => !(label === ProviderLabel.Detected && detected2 || label === ProviderLabel.MetaMask && metamask2);
...
var walletModule = import_joi.default.object({
  ...
  getIcon: import_joi.default.function().arity(1).required(),
  getInterface: import_joi.default.function().arity(1).required(),
  injectedNamespace: import_joi.default.string().required(),
  checkProviderIdentity: import_joi.default.function().arity(1).required().required(),
...
function injected(options) {
  ...
  return (helpers) => {
    ...
    const { custom = [], filter: filter2 = {} } = options || {};
    const allWallets = [...custom, ...wallets_default];
    const deduped = (0, import_lodash.default)(allWallets, ({ label }) => `${label}`);
    const filteredWallets = deduped.filter((wallet) => {
      ...
      const excludedDevice = Array.isArray(walletFilters) && (walletFilters.includes(device.type) || walletFilters.includes(device.os.name));
    ...
    const validWallets = filteredWallets.filter(({ injectedNamespace, checkProviderIdentity, label }) => {
      ...
      if (walletExists && provider && provider.isMetaMask && label !== ProviderLabel.MetaMask && label !== "Detected Wallet") {
        removeMetaMask = true;
      }
      return walletExists;
    });
    if (validWallets.length) {
      ...
      return validWallets.filter(remove({
...
// dep:@web3-onboard_injected-wallets
var web3_onboard_injected_wallets_default = dist_default;
export {
  ProviderIdentityFlag,
  ProviderLabel,
  web3_onboard_injected_wallets_default as default
};

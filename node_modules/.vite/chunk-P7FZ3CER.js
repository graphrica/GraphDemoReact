    ...
    function _getInitializedChains(customChains) {
      ...
      if (customChains) {
        try {
          ...
          try {
            if (customChains_1_1 && !customChains_1_1.done && (_a = customChains_1.return))
              _a.call(customChains_1);
          } finally {
            if (e_1)
              throw e_1.error;
          }
...
// node_modules/@ethereumjs/common/dist.browser/hardforks/preMerge.json
var require_preMerge = __commonJS({
  "node_modules/@ethereumjs/common/dist.browser/hardforks/preMerge.json"(exports, module) {
    module.exports = {
      name: "preMerge",
    ...
    var Common = function(_super) {
      ...
      Common2.prototype.setChain = function(chain) {
        ...
        if (typeof chain === "number" || typeof chain === "string" || ethereumjs_util_1.BN.isBN(chain)) {
          ...
          try {
            ...
            try {
              if (required_1_1 && !required_1_1.done && (_a = required_1.return))
                _a.call(required_1);
            } finally {
              if (e_2)
                throw e_2.error;
      ...
      Common2.prototype.setHardfork = function(hardfork) {
        ...
        try {
          ...
          try {
            if (HARDFORK_CHANGES_1_1 && !HARDFORK_CHANGES_1_1.done && (_a = HARDFORK_CHANGES_1.return))
              _a.call(HARDFORK_CHANGES_1);
          } finally {
            if (e_3)
              throw e_3.error;
          }
      ...
      Common2.prototype._getHardfork = function(hardfork) {
        ...
        try {
          ...
          try {
            if (hfs_1_1 && !hfs_1_1.done && (_a = hfs_1.return))
              _a.call(hfs_1);
          } finally {
            if (e_5)
              throw e_5.error;
      ...
      Common2.prototype.setEIPs = function(eips) {
        ...
        try {
          ...
          try {
            if (eips_2_1 && !eips_2_1.done && (_a = eips_2.return))
              _a.call(eips_2);
          } finally {
            if (e_7)
              throw e_7.error;
      ...
      Common2.prototype.param = function(topic, name) {
        var e_8, _a;
        var value = null;
        try {
      ...
      Common2.prototype.paramByHardfork = function(topic, name, hardfork) {
        var e_9, _a, e_10, _b;
        ...
        try {
          for (var HARDFORK_CHANGES_2 = __values(hardforks_1.hardforks), HARDFORK_CHANGES_2_1 = HARDFORK_CHANGES_2.next(); !HARDFORK_CHANGES_2_1.done; HARDFORK_CHANGES_2_1 = HARDFORK_CHANGES_2.next()) {
            ...
            if ("eips" in hfChanges[1]) {
              ...
              try {
                ...
                try {
                  if (hfEIPs_1_1 && !hfEIPs_1_1.done && (_b = hfEIPs_1.return))
                    _b.call(hfEIPs_1);
                } finally {
                  if (e_10)
                    throw e_10.error;
          ...
          try {
            if (HARDFORK_CHANGES_2_1 && !HARDFORK_CHANGES_2_1.done && (_a = HARDFORK_CHANGES_2.return))
              _a.call(HARDFORK_CHANGES_2);
          } finally {
            if (e_9)
              throw e_9.error;
          }
      ...
      Common2.prototype.paramByEIP = function(topic, name, eip) {
      ...
      Common2.prototype.paramByBlock = function(topic, name, blockNumber) {
      ...
      Common2.prototype.isActivatedEIP = function(eip) {
        ...
        try {
          ...
          try {
            if (HARDFORK_CHANGES_3_1 && !HARDFORK_CHANGES_3_1.done && (_a = HARDFORK_CHANGES_3.return))
              _a.call(HARDFORK_CHANGES_3);
          } finally {
            if (e_11)
              throw e_11.error;
          }
      ...
      Common2.prototype.hardforkGteHardfork = function(hardfork1, hardfork2, opts) {
        ...
        try {
          ...
          try {
            if (hardforks_2_1 && !hardforks_2_1.done && (_a = hardforks_2.return))
              _a.call(hardforks_2);
          } finally {
            if (e_12)
              throw e_12.error;
      ...
      Common2.prototype.activeHardforks = function(blockNumber, opts) {
        ...
        try {
          ...
          try {
            if (hfs_2_1 && !hfs_2_1.done && (_a = hfs_2.return))
              _a.call(hfs_2);
          } finally {
            if (e_14)
              throw e_14.error;
      ...
      Common2.prototype.consensusType = function() {
        ...
        try {
          ...
          try {
            if (HARDFORK_CHANGES_4_1 && !HARDFORK_CHANGES_4_1.done && (_a = HARDFORK_CHANGES_4.return))
              _a.call(HARDFORK_CHANGES_4);
          } finally {
            if (e_17)
              throw e_17.error;
          }
      ...
      Common2.prototype.consensusAlgorithm = function() {
        ...
        try {
          ...
          try {
            if (HARDFORK_CHANGES_5_1 && !HARDFORK_CHANGES_5_1.done && (_a = HARDFORK_CHANGES_5.return))
              _a.call(HARDFORK_CHANGES_5);
          } finally {
            if (e_18)
              throw e_18.error;
          }
      ...
      Common2.prototype.consensusConfig = function() {
        ...
        try {
          ...
          try {
            if (HARDFORK_CHANGES_6_1 && !HARDFORK_CHANGES_6_1.done && (_a = HARDFORK_CHANGES_6.return))
              _a.call(HARDFORK_CHANGES_6);
          } finally {
            if (e_19)
              throw e_19.error;
          }
...
//# sourceMappingURL=chunk-P7FZ3CER.js.map

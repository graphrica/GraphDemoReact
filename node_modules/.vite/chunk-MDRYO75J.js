import {
  ...
  init_lib4 as init_lib13,
  init_lib5 as init_lib14,
  sha256,
  shuffled
...
var init_formatter = __esm({
  "node_modules/@ethersproject/providers/lib.esm/formatter.js"() {
    ...
    Formatter = class {
      constructor() {
        logger3.checkNew(new.target, Formatter);
  ...
  "node_modules/@ethersproject/providers/lib.esm/json-rpc-provider.js"() {
    ...
    JsonRpcSigner = class extends Signer {
      constructor(constructorGuard, provider, addressOrIndex) {
        logger5.checkNew(new.target, JsonRpcSigner);
        super();
    ...
    JsonRpcProvider = class extends BaseProvider {
      constructor(url, network) {
        logger5.checkNew(new.target, JsonRpcProvider);
...
var __awaiter8, logger11, defaultApiKey3, EtherscanProvider;
var init_etherscan_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/etherscan-provider.js"() {
    ...
    EtherscanProvider = class extends BaseProvider {
      constructor(network, apiKey) {
        logger11.checkNew(new.target, EtherscanProvider);
        super(network);
      ...
      getBaseUrl() {
        ...
        return logger11.throwArgumentError("unsupported network", "network", name);
      }
  ...
  "node_modules/@ethersproject/providers/lib.esm/fallback-provider.js"() {
    ...
    FallbackProvider = class extends BaseProvider {
      constructor(providers, quorum) {
        logger12.checkNew(new.target, FallbackProvider);
...
var logger14, defaultApiKey4, NodesmithProvider;
...
var logger15, defaultApplicationIds, PocketProvider;
var init_pocket_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/pocket-provider.js"() {
    ...
    PocketProvider = class extends UrlJsonRpcProvider {
      ...
      static getApiKey(apiKey) {
        if (apiKey == null) {
          logger15.throwArgumentError("PocketProvider.getApiKey does not support null apiKey", "apiKey", apiKey);
        }
        const apiKeyObj = {
          applicationId: null,
          loadBalancer: false,
        ...
        if (typeof apiKey === "string") {
          ...
          logger15.assertArgument(typeof apiKey.applicationId === "string", "applicationSecretKey requires an applicationId", "applicationId", apiKey.applicationId);
          logger15.assertArgument(typeof apiKey.applicationSecretKey === "string", "invalid applicationSecretKey", "applicationSecretKey", "[REDACTED]");
          apiKeyObj.applicationId = apiKey.applicationId;
          apiKeyObj.applicationSecretKey = apiKey.applicationSecretKey;
          apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
        } else if (apiKey.applicationId) {
          logger15.assertArgument(typeof apiKey.applicationId === "string", "apiKey.applicationId must be a string", "apiKey.applicationId", apiKey.applicationId);
          apiKeyObj.applicationId = apiKey.applicationId;
          apiKeyObj.loadBalancer = !!apiKey.loadBalancer;
        } else {
  ...
  "node_modules/@ethersproject/providers/lib.esm/web3-provider.js"() {
    ...
    Web3Provider = class extends JsonRpcProvider {
      constructor(provider, network) {
        logger16.checkNew(new.target, Web3Provider);
        if (provider == null) {
...
export {
  getNetwork,
  lib_exports,
  init_lib16 as init_lib,
  _fetchData,
  fetchJson,
  poll,
  init_lib17 as init_lib2,
  Formatter,
  ...
  getDefaultProvider,
  lib_exports2,
  init_lib18 as init_lib3
};
//# sourceMappingURL=chunk-MDRYO75J.js.map

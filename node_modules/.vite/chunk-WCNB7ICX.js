...
var require_utils = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/utils.js"(exports) {
    "use strict";
    init_define_process_env();
    ...
    var RxOp = __importStar((init_operators(), __toCommonJS(operators_exports)));
    exports.DEFAULT_TIMEOUT = 5e3;
    exports.LONG_TIMEOUT = 5 * 60 * 1e3;
    ...
    function hardenedPath(path) {
      return path.filter((segment) => segment >= 2147483648);
    }
    ...
    var needCompatibleBufferConcat = void 0;
...
var require_binance = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/binance.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function binanceDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Binance")) {
        return unknown;
      }
...
// node_modules/type-assertions/lib/index.js
var require_lib = __commonJS({
  "node_modules/type-assertions/lib/index.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    function assert() {
...
var require_bitcoin = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/bitcoin.js"(exports) {
    "use strict";
    init_define_process_env();
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
    ...
    var ta = __importStar(require_lib());
    var utils_1 = require_utils();
    ta.assert();
    ...
    (function(BTCOutputAddressType2) {
      ...
      BTCOutputAddressType2["Exchange"] = "exchange";
    ...
    function describeUTXOPath(path, coin, scriptType) {
      ...
      if (path[1] !== 2147483648 + slip44) {
        switch (coin) {
          case "BitcoinCash":
          case "BitcoinGold": {
            if (path[1] === 2147483648 + utils_1.slip44ByCoin("Bitcoin")) {
              isPrefork = true;
              break;
            }
            return unknown;
          ...
          case "BitcoinSV": {
            if (path[1] === 2147483648 + utils_1.slip44ByCoin("Bitcoin") || path[1] === 2147483648 + utils_1.slip44ByCoin("BitcoinCash")) {
              isPrefork = true;
              break;
            }
            return unknown;
...
var require_cosmos = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/cosmos.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function cosmosDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Atom")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_osmosis = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/osmosis.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function osmosisDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Osmo")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_debuglink = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/debuglink.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
  }
...
var require_eos = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/eos.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
  }
...
var require_ethereum = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/ethereum.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function describeETHPath(path) {
      ...
      if (path[0] !== 2147483648 + 44)
        return unknown;
      if (path[1] !== 2147483648 + utils_1.slip44ByCoin("Ethereum"))
        return unknown;
      if ((path[2] & 2147483648) >>> 0 !== 2147483648)
        return unknown;
      if (path[3] !== 0)
...
var require_event = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/event.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_exceptions = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/exceptions.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var HDWalletError = class extends Error {
    ...
    var FirmwareUpdateRequired = class extends HDWalletError {
    ...
    var WebHIDNotAvailable = class extends HDWalletError {
      constructor() {
    ...
    var WebUSBNotAvailable = class extends HDWalletError {
      constructor() {
    ...
    var WebHIDCouldNotInitialize = class extends HDWalletError {
    ...
    var WebUSBCouldNotInitialize = class extends HDWalletError {
      constructor(model, message) {
...
var require_fio = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/fio.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function(Fio2) {
      ...
      (function(ContentType2) {
        ContentType2["REQUEST"] = "new_funds_content";
        ContentType2["OBT"] = "record_obt_data_content";
      })(ContentType = Fio2.ContentType || (Fio2.ContentType = {}));
    ...
    function fioDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Fio")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_kava = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/kava.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function kavaDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Kava")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_keyring = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/keyring.js"(exports) {
    "use strict";
    init_define_process_env();
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
    ...
    var eventemitter2 = __importStar(require_eventemitter2());
    var Keyring = class extends eventemitter2.EventEmitter2 {
      constructor() {
        super({ wildcard: true });
        this.wallets = {};
        this.aliases = {};
...
var require_ripple = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/ripple.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
  }
...
var require_secret = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/secret.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function secretDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Secret")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_terra = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/terra.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function terraDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Terra")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_thorchain = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/thorchain.js"(exports) {
    "use strict";
    init_define_process_env();
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function thorchainDescribePath(path) {
      ...
      if (path[1] != 2147483648 + utils_1.slip44ByCoin("Rune")) {
        return unknown;
      }
      if ((path[2] & 2147483648) >>> 0 !== 2147483648) {
        return unknown;
...
var require_transport = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/transport.js"(exports) {
    "use strict";
    init_define_process_env();
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
    ...
    var eventemitter2 = __importStar(require_eventemitter2());
    var Transport = class extends eventemitter2.EventEmitter2 {
      constructor(keyring) {
        super();
...
var require_wallet = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/wallet.js"(exports) {
    "use strict";
    init_define_process_env();
...
var require_dist = __commonJS({
  "node_modules/@shapeshiftoss/hdwallet-core/dist/index.js"(exports) {
    init_define_process_env();
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m, k, k2) {
      if (k2 === void 0)
        k2 = k;
 ...
 */
//# sourceMappingURL=chunk-WCNB7ICX.js.map

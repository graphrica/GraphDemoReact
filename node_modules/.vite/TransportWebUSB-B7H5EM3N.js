...
var TransportWebUSB = function(_super) {
  __extends(TransportWebUSB2, _super);
  function TransportWebUSB2(device, interfaceNumber) {
  ...
  TransportWebUSB2.request = function() {
    return __awaiter3(this, void 0, void 0, function() {
      var device;
      return __generator3(this, function(_a2) {
        switch (_a2.label) {
          case 0:
            return [4, requestLedgerDevice()];
          case 1:
            device = _a2.sent();
            return [2, TransportWebUSB2.open(device)];
        }
      });
    });
  };
  TransportWebUSB2.openConnected = function() {
    return __awaiter3(this, void 0, void 0, function() {
      var devices2;
      return __generator3(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            ...
            if (devices2.length === 0)
              return [2, null];
            return [2, TransportWebUSB2.open(devices2[0])];
        }
      });
    });
  };
  TransportWebUSB2.open = function(device) {
    return __awaiter3(this, void 0, void 0, function() {
      ...
      return __generator3(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 2:
            ...
            _a2.label = 3;
          case 3:
            return [4, gracefullyResetDevice(device)];
          case 4:
            _a2.sent();
            iface = device.configurations[0].interfaces.find(function(_a3) {
              var alternates = _a3.alternates;
          ...
          case 9:
            transport = new TransportWebUSB2(device, interfaceNumber);
  ...
  TransportWebUSB2.prototype.close = function() {
    return __awaiter3(this, void 0, void 0, function() {
      return __generator3(this, function(_a2) {
        switch (_a2.label) {
          case 0:
  ...
  TransportWebUSB2.prototype.exchange = function(apdu) {
    return __awaiter3(this, void 0, void 0, function() {
      var b;
      var _this = this;
      return __generator3(this, function(_a2) {
          ...
          case 0:
            return [4, this.exchangeAtomicImpl(function() {
              return __awaiter3(_this, void 0, void 0, function() {
                var _a3, channel, packetSize, framing, blocks, i, result, acc, r, buffer;
  ...
  TransportWebUSB2.prototype.setScrambleKey = function() {
  };
  TransportWebUSB2.isSupported = isSupported;
  TransportWebUSB2.list = getLedgerDevices;
  TransportWebUSB2.listen = function(observer) {
...
//# sourceMappingURL=TransportWebUSB-B7H5EM3N.js.map

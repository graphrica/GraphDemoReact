...
// node_modules/react-simplemde-editor/lib/index.js
var require_lib = __commonJS({
  "node_modules/react-simplemde-editor/lib/index.js"(exports) {
    "use strict";
    init_define_process_env();
    ...
    var _easymde = _interopRequireDefault(require_easymde());
    ...
    var useHandleEditorInstanceLifecycle = function useHandleEditorInstanceLifecycle2(_ref) {
      var options = _ref.options, id = _ref.id, currentValueRef = _ref.currentValueRef, textRef = _ref.textRef;
      var _useState = (0, _react.useState)(null), _useState2 = (0, _slicedToArray2.default)(_useState, 2), editor = _useState2[0], setEditor = _useState2[1];
      var imageUploadCallback = (0, _react.useCallback)(function(file, onSuccess, onError) {
        ...
        if (imageUpload) {
          var _onSuccess = function _onSuccess2(url) {
            onSuccess(url);
          };
      ...
      (0, _react.useEffect)(function() {
        ...
        if (textRef) {
          ...
          var imageUploadFunction = (options === null || options === void 0 ? void 0 : options.imageUploadFunction) ? imageUploadCallback : void 0;
          editor2 = new _easymde.default(Object.assign({}, initialOptions, options, {
            imageUploadFunction
          }));
          setEditor(editor2);
        }
        return function() {
          ...
          (_editor = editor2) === null || _editor === void 0 ? void 0 : _editor.toTextArea();
          (_editor2 = editor2) === null || _editor2 === void 0 ? void 0 : _editor2.cleanup();
        };
    ...
    var SimpleMdeReact = _react.default.forwardRef(function(props, _ref8) {
      var events = props.events, value = props.value, options = props.options, children = props.children, extraKeys = props.extraKeys, getLineAndCursor = props.getLineAndCursor, getMdeInstance = props.getMdeInstance, getCodemirrorInstance = props.getCodemirrorInstance, onChange = props.onChange, anId = props.id, rest = (0, _objectWithoutProperties2.default)(props, ["events", "value", "options", "children", "extraKeys", "getLineAndCursor", "getMdeInstance", "getCodemirrorInstance", "onChange", "id"]);
      var id = (0, _react.useMemo)(function() {
        return anId !== null && anId !== void 0 ? anId : generateId();
      }, [anId]);
      var elementWrapperRef = (0, _react.useRef)(null);
      var nonEventChangeRef = (0, _react.useRef)(true);
      var currentValueRef = (0, _react.useRef)(value);
      currentValueRef.current = value;
      var _useState3 = (0, _react.useState)(null), _useState4 = (0, _slicedToArray2.default)(_useState3, 2), textRef = _useState4[0], setTextRef = _useState4[1];
      var _useHandleEditorInsta = useHandleEditorInstanceLifecycle({
        options,
        id,
        currentValueRef,
        textRef
      }), editor = _useHandleEditorInsta.editor, codemirror = _useHandleEditorInsta.codemirror;
      (0, _react.useEffect)(function() {
      ...
      (0, _react.useEffect)(function() {
        ...
        isNotFirstEffectRun && prevEvents.current && Object.entries(prevEvents.current).forEach(function(_ref2) {
          var _ref3 = (0, _slicedToArray2.default)(_ref2, 2), event = _ref3[0], handler = _ref3[1];
        ...
        events && Object.entries(events).forEach(function(_ref4) {
          var _ref5 = (0, _slicedToArray2.default)(_ref4, 2), event = _ref5[0], handler = _ref5[1];
        ...
        return function() {
          events && Object.entries(events).forEach(function(_ref6) {
            var _ref7 = (0, _slicedToArray2.default)(_ref6, 2), event = _ref7[0], handler = _ref7[1];
            handler && (codemirror === null || codemirror === void 0 ? void 0 : codemirror.off(event, handler));
          });
        };
      }, [codemirror, events]);
...
// dep:react-simplemde-editor
init_define_process_env();
var react_simplemde_editor_default = require_lib();
export {
  react_simplemde_editor_default as default
};
